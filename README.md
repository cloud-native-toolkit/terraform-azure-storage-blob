...
Module that provisions an Azure Storage, including the following resources:
- storage_account (Storage Account)
- storage_container (Storage Container *Optional*)
- blob_file (Blob File *Optional*)
...
module "storage_blob" {
    ...
    blob_file_name            = "testfile.txt"
    blob_file_sourcefile_name = "testfile.txt"
}
```
